    ...
    public function add()
    {
        if ($this->request->is('post'))
        {
            ...
            try
            {
                ...
                {
                    $this->Session->setFlash('Your category has been saved.','flash',array('alert'=>'success'));
    ...
    public function deleteall()
    {
        try
        {
            if ($this->request->is('post'))
            {
                ...
                $this->Session->setFlash('Your category has been deleted.','flash',array('alert'=>'success'));
            }        
            $this->redirect(array('action' => 'index'));
        }
        catch (Exception $e)
        {
            $this->Session->setFlash('Can not delete category! Please delete related entries first','flash',array('alert'=>'danger'));
            return $this->redirect(array('action' => 'index'));
        }
    }    
}
