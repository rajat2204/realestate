...
(1, 'Real CRM', 'CRM', 'http://127.0.0.1:88/realestate', 'demo@demo.com', 'Real CRM', 'Real CRM', 'Asia/Kolkata', '', 0, 1, 0, 0, 1, 0, '1234567890, 1234567891', '42a7f37b3c078bba3e864323cc1d7128.png', '537f17a76864d11438d25ff5af7641a5.gif', 'd,m,Y,h,i,s,A,-,:', 'Site Office: DEMO Demo, Flat no. 101, Near Demo School, Behind Demo city mall, Demo Road, Demo, Demo (w) - 400615', '"M/s. DEMO INFRASTRACTURE PVT. LTD."(Bank Name) DEMO BANK, Demo Branch, Account No :- "005705014187"', 'DEMO', 15, 18, '2015-11-20 20:56:04', '2015-12-17 13:20:23');
