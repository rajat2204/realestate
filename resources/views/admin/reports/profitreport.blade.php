      ...
      <div class="col-md-12">
        <div class="panel panel-default m-t-20">
          ...
          <div class="box-body">
            <div class="row">
              <div class="col-md-6">
                <div class="classFloat centerContent"><button class="btn btn-primary" type="button">Total Profit and Loss this month <span class="badge"><i class="fa fa-rupee"></i> 100,000</span></button></div>
              </div>
              <div class="col-md-6">
                <div class="centerContent"><button class="btn btn-primary" type="button">Total Profit and Loss this month <span class="badge"><i class="fa fa-rupee"></i> 100,000</span></button></div>
              </div>
            </div>
