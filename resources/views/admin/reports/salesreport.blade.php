          ...
          <div class="box-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <br><br>Total Sale this month <span class="badge"><i class="fa fa-rupee"></i>{{array_sum($month_sum)}}</span></button></div>
              </div>
              <div class="col-md-6">
                <div class="centerContent"><button class="btn btn-primary" type="button">Total Sale Count <span class="badge">{{count($purchase_year)}}</span>
                <br><br>Total Sale <span class="badge"><i class="fa fa-rupee"></i>{{array_sum($total_sum)}}</span></button></div>
              </div>
            </div>
            ...
            <div class="row m-t-20">
              ...
              <div class="col-md-4">
                  <select class="form-control" id="PurchasereportProjectId" name="client_id">
                  <option value="">Select Client Name</option>
                  <option value="">All</option>
                  @foreach($client as $clients)
                    <option value="{{!empty($clients['id'])?$clients['id']:''}}" @if($client_id==$clients['id']) selected @endif>{{!empty($clients['name'])?$clients['name']:''}}</option>
                  @endforeach
                </select>
              </div>
              <div class="col-md-3">
            ...
            <div class="row m-t-20">
              ...
              <div class="col-md-2">
                ...
                <a href="{{url('admin/salesreport')}}" class="btn btn-warning btn-sm"><span class="fa fa-refresh"></span>&nbsp;Reset</a>        
              </div>
          </div>
        </form>
