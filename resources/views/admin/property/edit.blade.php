            ...
            <div class="form-group">
              ...
              <select class="form-control" name="project_id" id="project_id">
                ...
                @foreach($project as $projects)
                  <option value="{{!empty($projects['id'])?$projects['id']:''}}" @if($projects['id'] == $property['project_id']) selected @endif >{{!empty($projects['name'])?$projects['name']:''}}</option>
                @endforeach
              </select>
            </div>
          </div>
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="unit_id">
                ...
                @foreach($units as $unit)
                  <option value="{{!empty($unit['id'])?$unit['id']:''}}" @if($unit['id'] == $property['unit_id']) selected @endif >{{!empty($unit['name'])?$unit['name']:''}}</option>
                @endforeach
              </select>
            </div>
          </div>
