	...
	<head>
	    ...
	    <title>Devdrishti Infrahomes Pvt Ltd</title>
	 	...
	 	<!-- Font Awesome -->
	  	...
	  	<!-- AdminLTE Skins. Choose a skin from the css/skins folder instead of downloading all of them 	  	<link rel="stylesheet" href="{{asset('assets/dist/css/skins/_all-skins.min.css')}}">
	  	Morris chart -->
