<div class="content-wrapper">
  <div class="box box-warning">
    ...
    <!-- /.box-header -->
    <div class="box-body">
      <form role="add-payment" method="POST" action="{{url('admin/purchase/payment/'.___encrypt($purchase['id']))}}">
        {{csrf_field()}}
        <input type="hidden" name="balance" value="{{!empty($purchase['balance'])?$purchase['balance']:''}}">

        <div class="form-group">
          <label>Amount:</label>
          <input type="text" class="form-control" placeholder="Enter Amount..." name="amount">
        </div>
        <input type="hidden" name="purchase_id" value="{{!empty($purchase['id'])?$purchase['id']:''}}">
