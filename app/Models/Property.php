...
class Property extends Model
{
    ...
    protected $fillable = ['project_id','category_id','company_id','name','agent_id','slug','featured_image','price','location','pincode','latitude','longitude','property_type','property_purpose','bedrooms','bathroom','garage','area','possession','description','key_points','status','featured','created_at','updated_at'];
