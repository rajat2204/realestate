    ...
    public function index(Request $request, Builder $builder){
        ...
        if ($request->ajax()) {
            ...
            ->editColumn('action',function($item){
                ...
                $html   .= '<a href="'.url(sprintf('admin/leads/%s/edit',___encrypt($item['id']))).'"  title="Edit Detail"><i class="fa fa-edit"></i></a> | ';
                ...
                if($item['status'] == 'active'){
                    $html   .= '<a href="javascript:void(0);" 
                        data-url="'.url(sprintf('admin/leads/status/?id=%s&status=inactive',$item['id'])).'" 
                        data-request="ajax-confirm"
                    ...
                    $html   .= '<a href="javascript:void(0);" 
                        data-url="'.url(sprintf('admin/leads/status/?id=%s&status=active',$item['id'])).'" 
                        data-request="ajax-confirm"
